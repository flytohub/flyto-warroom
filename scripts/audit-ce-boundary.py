...
REQUIRED_MARKERS = {
    ...
    "services/flyto-engine-ce/README.md": [
        "complete source-published Community Edition runtime",
        "generated by `flyto2-open-core-export`",
        "Do not add private production handlers",
    ],
    "packages/flyto-code/CE_SOURCE_BOUNDARY.md": [
        "physically independent Community Edition frontend",
        "local administrator creation",
        "SaaS/Enterprise control plane remain outside",
    ],
    "docs/enterprise-cloud-bridge.md": [
