...
Stable Git tags build immutable Docker Hub aliases. For Git tag `v0.5.3`,
the release workflow builds `engine-ce-0.5.3`,
`worker-ce-0.5.3`, `scheduler-ce-0.5.3`,
`analysis-ce-0.5.3`, `report-ce-0.5.3`, and
`code-ce-0.5.3` directly from tagged public source for
