...
Stable Git tags build immutable Docker Hub aliases. For Git tag `v0.3.1`, the
release workflow builds `engine-ce-0.3.1`, `worker-ce-0.3.1`, and
`code-ce-0.3.1` directly from the tagged public source for `linux/amd64` and
