...
Stable Git tags build immutable Docker Hub aliases. For Git tag `v0.3.2`, the
release workflow builds `engine-ce-0.3.2`, `worker-ce-0.3.2`, and
`code-ce-0.3.2` directly from the tagged public source for `linux/amd64` and
