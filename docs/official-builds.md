...
Stable Git tags build immutable Docker Hub aliases. For Git tag `v0.5.2`,
the release workflow builds `engine-ce-0.5.2`,
`worker-ce-0.5.2`, `scheduler-ce-0.5.2`,
`analysis-ce-0.5.2`, `report-ce-0.5.2`, and
`code-ce-0.5.2` directly from tagged public source for
