...
type Response struct {
	...
	Scope             LoopScope           `json:"scope"`
	Summary           LoopSummary         `json:"summary"`
	Assets            []LoopAsset         `json:"assets"`
	Findings          []LoopFinding       `json:"findings"`
	AttackPaths       []LoopAttackPath    `json:"attack_paths"`
	Evidence          []LoopEvidence      `json:"evidence"`
	Remediation       []LoopRemediation   `json:"remediation"`
	Validation        []LoopValidation    `json:"validation"`
	SLA               sla.AgingReport     `json:"sla"`
	MergeContract     LoopMergeContract   `json:"merge_contract"`
	EnterpriseOverlay []EnterpriseOverlay `json:"enterprise_overlay"`
...
func Build(now time.Time) Response {
	...
	return Response{
		...
		SLA:         aging,
		MergeContract: LoopMergeContract{
		...
		EnterpriseOverlay: []EnterpriseOverlay{
